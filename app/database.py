...
Classes:
    ...
    - DatabaseInitializer: Handles initialization of the database and tables.
    - UserPrivilegesManager: Manages user privileges within the database.
    - UserResetManager: Handles resetting recognized counts for users based on their subscription plans.
...
class DatabaseConnection:
    """
    A class used to manage the database connection.
    ...
    def create_connection():
        ...
        Returns:
            connection (MySQLConnection): MySQL database connection object or None if connection fails.
        """
        try:
...
class DatabaseInitializer:
    """
    A class used to initialize the MySQL database.

    Methods:
    -------
    init_db():
        Initializes the MySQL database by creating necessary tables.
    """
...
class UserPrivilegesManager:
    """
    A class used to manage user privileges within the database.
...
class UserResetManager:
    """
    A class used to handle resetting recognized counts for users based on their subscription plans.
...
if __name__ == "__main__":
    ...
    UserPrivilegesManager.revoke_drop_privileges()
    UserResetManager.reset_recognized_count()
